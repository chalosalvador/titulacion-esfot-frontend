    ...
    const contentApproveModal =
      <>
        <Checkbox.Group onChange={ onChange }>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Título del trabajo de titulación</Title>
            </Col>
          </Row>
          <Row>
            <Col>
              <Checkbox style={ { marginLeft: 8 } } value={ '1' }>Está redactando de forma clara, precisa y
                entendible.</Checkbox>
              <Checkbox value={ '2' }>Describe el problema y la solución.</Checkbox>
              <Checkbox value={ '3' }>Describe el tema que es objetivo del estudio.</Checkbox>
              <Checkbox value={ '4' }>Está de acuerdo a los objetivos planteados.</Checkbox>
            </Col>
          </Row>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Planteamiento del problema</Title>
            </Col>
          </Row>
          <Row>
            <Col>
              <Checkbox style={ { marginLeft: 8 } } value={ '5' }>Identifica síntomas causas que permiten
                pronosticar <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;las consecuencias si persiste el problema.</Checkbox>
              <Checkbox value={ '6' }>Describe el problema y la solución.</Checkbox>
              <Checkbox value={ '7' }>Describe el tema que es objetivo del estudio.</Checkbox>
            </Col>
          </Row>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Justificación</Title>
            </Col>
          </Row>
          <Row>
            <Col>
              <Checkbox style={ { marginLeft: 8 } } value={ '8' }>Justifica el ¿por qué? Y ¿para qué? Se realiza el
                trabajo.</Checkbox>
              <Checkbox value={ '9' }>Presenta las debidas evidencias.</Checkbox>
              <Checkbox value={ '10' }>Desglosa la justificación teórica, metodológica y/o práctica.</Checkbox>
            </Col>
          </Row>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Objetivo General</Title>
            </Col>
          </Row>
          <Row>
            <Col>
              <Checkbox style={ { marginLeft: 8 } } value={ '11' }>Acorde al título del trabajo de titulación, escrito en
                verbo infinitivo.</Checkbox>
            </Col>
          </Row>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Objetivos específicos</Title>
            </Col>
          </Row>
          <Row>
            <Col>
              <Checkbox style={ { marginLeft: 8 } } value={ '12' }>Presenta más de 2 objetivos específicos, escritos en
                verbos infinitivos.</Checkbox>
              <Checkbox value={ '13' }>No son pasos metodológicos, procedimientos, actividades.</Checkbox>
            </Col>
          </Row>
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Metodología</Title>
            </Col>
          </Row>
          <Row>
            <Col>
          ...
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Plan de trabajo</Title>
            </Col>
          </Row>
          <Row>
            <Col>
          ...
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Cronograma</Title>
            </Col>
          </Row>
          <Row>
            <Col>
          ...
          <Row>
            <Col>
              <Title level={ 4 } style={ { color: '#034c70' } }>Bibliografía</Title>
            </Col>
          </Row>
          <Row>
            <Col>
