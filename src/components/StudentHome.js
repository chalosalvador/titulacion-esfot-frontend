...
const StudentHomePage = () => {
    ...
    if (projects[0] && projects[0].status === 'date_defense_assigned') {
        for (let i = 0; i < juries.length; i++) {
            if (juries[i].project_id === projects[0].id) {
    ...
    return (
        <>
                        ...
                        <Col span={6}>
                            ...
                            >
                                <Space direction="vertical" size="large">
                                    ...
                                    <div>
                                        <Button
                                            disabled={!projects[0] || projects[0].status !== "date_defense_assigned"}
                                            onClick={getJuryInfo}>
                                            Ver
                                        </Button>
                                    </div>
            ...
            <Modal
                ...
                title={<Title level={3} style={{color: "#034c70"}}>
                    ¡Buen trabajo!
                </Title>}
                okText="Entendido"
                closable={true}
            ...
            >
                <>
                    ...
                    <Row>
                        <Col>
                            <p style={{color: "#034c70", fontSize: 23}}>
                                <br/>
                                La fecha asignada para tu defensa oral es: {schedule}
                                <br/>
                            </p>
                        </Col>
                    </Row>
